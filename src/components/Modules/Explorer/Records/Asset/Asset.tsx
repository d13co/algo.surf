              ...
              <div className="asset-body">
                    ...
                    <div style={{ marginTop: 5 }}>
                      {assetInstance.getUrl() ? (
                        <>
                          ...
                          <Copyable size="s" value={assetInstance.getUrl()} />
                        </>
                      ) : (
                        ""
                      )}
                ...
                <div className="props" style={{ background: shadedClr }}>
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={6} md={6} lg={6} xl={6}>
                      <div className="property">
                        <div className="key">Metadata hash</div>
                        <div className="value addr">
                    ...
                    <Grid item xs={12} sm={6} md={3} lg={3} xl={3}>
                      <div className="property">
                        <div className="key">Default frozen</div>
                        <div className="value">
                ...
                <div className="props" style={{ background: shadedClr }}>
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={6} md={6} lg={6} xl={6}>
                      <div className="property">
                        <div className="key">Clawback</div>
                        <div className="value addr">
                ...
                {assetInstance.getResolvedUrl() ? (
                  <div className="props" style={{ background: shadedClr }}>
                    <Grid container spacing={2}>
                      <Grid item xs={12} sm={6} md={3} lg={3} xl={3}>
                        <div className="property">
                          <div className="key">Resolved Url</div>
                          <div className="value addr">
                            {assetInstance.getResolvedUrl() ? (
                              <Link
