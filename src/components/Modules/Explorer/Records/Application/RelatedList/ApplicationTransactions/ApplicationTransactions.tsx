...
import {loadApplicationTransactions} from "../../../../../../../redux/explorer/actions/application";
    ...
    return (<div className={"application-transactions-wrapper"}>
        <div className={"application-transactions-container"}>
            <div className="application-transactions-body">
                <TransactionsList transactions={transactions} reachedLastPage={reachedLastPage} loading={application.transactionsDetails.loading} fields={['type', 'id', 'age', 'from', 'to', 'fee', ]}></TransactionsList>
            </div>
        </div>
    </div>);
}
